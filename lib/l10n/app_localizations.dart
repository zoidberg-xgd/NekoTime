...
abstract class AppLocalizations {
  ...
  /// No description provided for @themeTransparent.
  ///
  /// In en, this message translates to:
  /// **'Transparent'**
  String get themeTransparent;
  ...
  /// No description provided for @themeAquaGlass.
  ///
  /// In en, this message translates to:
  /// **'Aqua Glass'**
  String get themeAquaGlass;

  /// No description provided for @themeReload.
  ///
  /// In en, this message translates to:
  /// **'Reload themes'**
  String get themeReload;

  /// No description provided for @themeFolderHint.
  ///
  /// In en, this message translates to:
  /// **'Add or edit JSON theme files under {path} and press Reload to apply.'**
  ...
  /// No description provided for @lockPosition.
  ///
  /// In en, this message translates to:
  /// **'Lock Position'**
  String get lockPosition;

  /// No description provided for @unlockPosition.
  ///
  /// In en, this message translates to:
  /// **'Unlock Position'**
  ...
  /// No description provided for @layerDesktop.
  ///
  /// In en, this message translates to:
  /// **'Desktop'**
